...
const crearInstanciaPersona = (nombre, apellido, edad, dir)=>{
  ...
  const personOne = new Persona (nombre,apellido,edad,dir);
...
const sumarArray = (numeros, cb) =>{
  ...
  for(let i = 0; i < numeros.length; i++){
    // El metodo Number.isInteger() se usa para verificar si el numero es de tipo entero
...
function filter(array) {
  ...
  //El metodo charAt(0) es para obtener el caracter y el 0 es la posición, en este caso se obtiene la primera letra
  //El metodo toLowerCase() es para colocar la palabra en minuscula
